...
include(":system-tests:ids-did-auth-test:file-key-resolver")
include(":system-tests:ids-did-auth-test:runner")
include(":system-tests:ids-did-auth-test:provider")
include(":system-tests:ids-did-auth-test:consumer")
