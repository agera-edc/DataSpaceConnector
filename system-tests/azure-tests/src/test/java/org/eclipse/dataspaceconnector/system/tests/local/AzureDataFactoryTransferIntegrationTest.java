...
public class AzureDataFactoryTransferIntegrationTest extends AbstractAzureBlobTest {
    ...
    protected static EdcRuntimeExtension consumer = new EdcRuntimeExtension(
            ...
            Map.ofEntries(
                ...
                Map.entry("edc.vault.clientid", "9d236f09-93d9-4f41-88a6-20201a6a1abc"),
                Map.entry("edc.vault.tenantid", "72f988bf-86f1-41af-91ab-2d7cd011db47"),
                Map.entry("edc.vault.name", "kvageraadfadf"),
                Map.entry("edc.vault.clientsecret", "")
            ));
