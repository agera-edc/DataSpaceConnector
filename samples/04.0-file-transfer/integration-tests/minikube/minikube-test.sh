...
./gradlew :samples:04.0-file-transfer:integration-tests:test -DincludeTags="file-transfer-integration-test" --tests org.eclipse.dataspaceconnector.samples.FileTransferAsClientIntegrationTest
