...
./gradlew :samples:04.0-file-transfer:integration-tests:test -DIncludeTags="IntegrationTest" --tests org.eclipse.dataspaceconnector.samples.FileTransferAsClientIntegrationTest
