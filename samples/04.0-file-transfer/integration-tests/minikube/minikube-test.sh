...
./gradlew :samples:04.0-file-transfer:integration-tests:test -DIncludeTags="integration-test" --tests org.eclipse.dataspaceconnector.samples.FileTransferAsClientIntegrationTest
