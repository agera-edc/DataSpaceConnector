...
offer is prepared in [contractoffer.json](integration-tests/src/main/resources/contractoffer.json)
...
```bash
curl -X POST -H "Content-Type: application/json" -d @samples/04.0-file-transfer/integration-tests/src/main/resources/contractoffer.json "http://localhost:9191/api/negotiation?connectorAddress=http://localhost:8181/api/ids/multipart"
```
