...
public class LegacyDidPublicKeyResolverImpl implements LegacyDidPublicKeyResolver {
    private final DidResolverRegistry resolverRegistry;

    public LegacyDidPublicKeyResolverImpl(DidResolverRegistry resolverRegistry) {
    ...
    public Result<PublicKeyWrapper> resolvePublicKey(String didUrl) {
        ...
        try {
            return Result.success(new EcPublicKeyWrapper(KeyConverter.toEcKey((EllipticCurvePublicKey) jwk, verificationMethod.getId())));
