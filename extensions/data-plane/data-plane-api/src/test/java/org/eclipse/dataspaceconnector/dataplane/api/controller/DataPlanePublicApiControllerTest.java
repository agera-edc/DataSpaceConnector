...
class DataPlanePublicApiControllerTest {
    ...
    void setUp() {
        ...
        controller = new DataPlanePublicApiController(dataPlaneManagerMock, tokenValidationServiceMock, mock(Monitor.class), requestContextWrapperMock,
                TYPE_MANAGER, Executors.newSingleThreadExecutor());
    }
