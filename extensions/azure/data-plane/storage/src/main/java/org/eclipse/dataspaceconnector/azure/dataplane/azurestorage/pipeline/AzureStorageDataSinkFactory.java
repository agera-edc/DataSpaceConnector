...
public class AzureStorageDataSinkFactory implements DataSinkFactory {
    ...
    public AzureStorageDataSinkFactory(BlobAdapterFactory blobAdapterFactory, ExecutorService executorService, int partitionSize, Monitor monitor, Vault vault, TypeManager typeManager) {
