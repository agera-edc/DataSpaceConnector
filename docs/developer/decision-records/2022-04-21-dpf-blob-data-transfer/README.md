...
5. Provider stores the SAS token in its Vault. As DPF can be distributed, the transferProcess information needs to be persisted in a database for resiliency. TransferProcess secrets will be stored in a KeyStore.  
