...
package org.eclipse.dataspaceconnector.common.jsonweb.crypto.key;
...
import org.eclipse.dataspaceconnector.common.jsonweb.crypto.CryptoException;
...
public class EcPublicKeyWrapper implements PublicKeyWrapper {
    ...
    public EcPublicKeyWrapper(ECPublicKey publicKey) {
